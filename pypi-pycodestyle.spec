...
Source0  : https://files.pythonhosted.org/packages/06/6b/5ca0d12ef7dcf7d20dfa35287d02297f3e0f9e515da5183654c03a9636ce/pycodestyle-2.10.0.tar.gz
...
%prep
%setup -q -n pycodestyle-2.10.0
cd %{_builddir}/pycodestyle-2.10.0
pushd ..
cp -a pycodestyle-2.10.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669396989
