...
Source0  : https://files.pythonhosted.org/packages/34/8f/fa09ae2acc737b9507b5734a9aec9a2b35fa73409982f57db1b42f8c3c65/pycodestyle-2.11.1.tar.gz
...
%prep
%setup -q -n pycodestyle-2.11.1
cd %{_builddir}/pycodestyle-2.11.1
pushd ..
cp -a pycodestyle-2.11.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707132825
