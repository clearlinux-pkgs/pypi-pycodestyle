...
Source0  : https://files.pythonhosted.org/packages/43/aa/210b2c9aedd8c1cbeea31a50e42050ad56187754b34eb214c46709445801/pycodestyle-2.12.1.tar.gz
...
%prep
%setup -q -n pycodestyle-2.12.1
cd %{_builddir}/pycodestyle-2.12.1
pushd ..
cp -a pycodestyle-2.12.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722870948
