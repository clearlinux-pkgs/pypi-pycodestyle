...
Source0  : https://files.pythonhosted.org/packages/04/6e/1f4a62078e4d95d82367f24e685aef3a672abfd27d1a868068fed4ed2254/pycodestyle-2.13.0.tar.gz
...
%prep
%setup -q -n pycodestyle-2.13.0
cd %{_builddir}/pycodestyle-2.13.0
pushd ..
cp -a pycodestyle-2.13.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743430053
